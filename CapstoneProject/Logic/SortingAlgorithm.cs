...
namespace CapstoneProject.Logic
{
    public class SortingAlgorithm
    {
        ...
        {
            var ClientsPerDay = from c in _context.Clients where c.AvailableDate == oneDay select c;
        ...
        public List<DateTime> GetDatesToLoopThru()
        {
            ...
            {
                if (!dates.Contains(client.AvailableDate))
                {
                    dates.Add(client.AvailableDate);
                }
            }
        ...
        {
            if (clientOne.AvailableFrom == clientTwo.AvailableTo &&
